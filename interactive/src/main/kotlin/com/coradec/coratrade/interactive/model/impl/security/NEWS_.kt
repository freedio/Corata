...
class NEWS_(contractId: Int, symbol: String, currency: Currency, primaryXchg: PrimaryExchange) :
        BasicSecurity(contractId, symbol, Types.SecType.NEWS, currency, primaryXchg = primaryXchg)
