...
class StructuredOption(contractId: Int, symbol: String, currency: Currency, primaryXchg: PrimaryExchange) :
        BasicSecurity(contractId, symbol, Types.SecType.IOPT, currency, primaryXchg = primaryXchg)
