...
class Commodity(contractId: Int, symbol: String, currency: Currency, primaryXchg: PrimaryExchange) :
        BasicSecurity(contractId, symbol, Types.SecType.CMDTY, currency, primaryXchg = primaryXchg) {
