...
class Future(contractId: Int, symbol: String, currency: Currency, primaryXchg: PrimaryExchange) :
        BasicSecurity(contractId, symbol, Types.SecType.FUT, currency, primaryXchg = primaryXchg)
