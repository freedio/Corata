...
class Bond(contractId: Int, symbol: String, currency: Currency, primaryXchg: PrimaryExchange) :
        BasicSecurity(contractId, symbol, Types.SecType.BOND, currency, primaryXchg = primaryXchg) {
