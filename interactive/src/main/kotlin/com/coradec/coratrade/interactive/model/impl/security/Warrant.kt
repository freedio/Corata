...
class Warrant(contractId: Int, symbol: String, currency: Currency, primaryXchg: PrimaryExchange) :
        BasicSecurity(contractId, symbol, Types.SecType.WAR, currency, primaryXchg = primaryXchg)
