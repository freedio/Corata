...
class Forward(contractId: Int, symbol: String, currency: Currency, primaryXchg: PrimaryExchange) :
        BasicSecurity(contractId, symbol, Types.SecType.FWD, currency, primaryXchg = primaryXchg) {
