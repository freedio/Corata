...
class ContractForDifference(contractId: Int, symbol: String, currency: Currency, primaryXchg: PrimaryExchange) :
        BasicSecurity(contractId, symbol, Types.SecType.CFD, currency, primaryXchg = primaryXchg) {
