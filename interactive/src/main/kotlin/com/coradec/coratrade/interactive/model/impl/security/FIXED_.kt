...
class FIXED_(contractId: Int, symbol: String, currency: Currency, primaryXchg: PrimaryExchange) :
        BasicSecurity(contractId, symbol, Types.SecType.FIXED, currency, primaryXchg = primaryXchg)
