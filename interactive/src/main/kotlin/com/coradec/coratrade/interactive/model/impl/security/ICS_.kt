...
class ICS_(contractId: Int, symbol: String, currency: Currency, primaryXchg: PrimaryExchange) :
        BasicSecurity(contractId, symbol, Types.SecType.ICS, currency, primaryXchg = primaryXchg)
